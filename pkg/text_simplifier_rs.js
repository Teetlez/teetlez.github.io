 ...
 * @returns {string}
 */
export function simplify_text(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.simplify_text(ptr0, len0);
        deferred2_0 = ret[0];
        deferred2_1 = ret[1];
...
function __wbg_adapter_12(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h48ea23d491f0cc71(arg0, arg1);
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('text_simplifier_rs_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
